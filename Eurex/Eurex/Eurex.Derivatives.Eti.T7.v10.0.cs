...
/// </summary>
public enum BidPxIsLocked : byte {
    No = 0,
    Yes = 1,
    BidPxIsLockedMinimumValue = 1,
    BidPxIsLockedMinimumValue = 0,
};
...
/// </summary>
public enum OfferPxIsLocked : byte {
    No = 0,
    Yes = 1,
    OfferPxIsLockedMinimumValue = 1,
    OfferPxIsLockedMinimumValue = 0,
};
...
/// </summary>
public enum OrderQtyIsLocked : byte {
    No = 0,
    Yes = 1,
    OrderQtyIsLockedMinimumValue = 1,
    OrderQtyIsLockedMinimumValue = 0,
};
...
/// </summary>
public enum QuoteCancelReason : byte {
    Expired = 5,
    QuoteCancelReasonMinimumValue = 5,
    QuoteCancelReasonMinimumValue = 5,
};
...
public enum QuoteEntryRejectReason : uint {
    ...
    Contractcannotbetradedduetoinsufficienteligibility = 166,
...
/// </summary>
public enum SideIsLocked : byte {
    No = 0,
    Yes = 1,
    SideIsLockedMinimumValue = 1,
    SideIsLockedMinimumValue = 0,
};
...
/// </summary>
public enum TradeAggregationTransType : byte {
    New = 0,
    TradeAggregationTransTypeMinimumValue = 0,
    TradeAggregationTransTypeMinimumValue = 0,
};
...
public unsafe struct PreTradeRiskLimitsDefinitionRequest {
    public fixed byte MessageHeaderInComp[0];
    public fixed byte RequestHeaderComp[0];
    public ulong NettingCoefficient;
    public int MarketSegmentId;
    public RiskLimitPlatform RiskLimitPlatform;
...
public unsafe struct SrqsDealNotification {
    ...
    public MessageEventSource MessageEventSource;
    public TradingCapacity TradingCapacity;
    public byte NoSrqsTargetPartyTrdGrps;
...
/// <summary>
///  Struct for Srqs Hit Quote Grp Comp
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SrqsHitQuoteGrpComp {
    public ulong OrderQty;
    public ulong QuoteId;
    public Side Side;
    public fixed byte Pad7[7];
...
public unsafe struct SrqsNegotiationNotification {
    ...
    public Side Side;
    public TradeAggregationTransType TradeAggregationTransType;
...
/// <summary>
///  Struct for Srqs Quote Grp Comp
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SrqsQuoteGrpComp {
    public ulong QuoteId;
};
...
public unsafe struct SrqsQuoteNotification {
    ...
    public TradingCapacity TradingCapacity;
    public QuoteCancelReason QuoteCancelReason;
    public fixed byte Pad1[1];
    public uint PartyIdExecutingTrader;
    public fixed sbyte PartyExecutingFirm[5];
    public fixed sbyte PartyExecutingTrader[6];
...
/// <summary>
///  Struct for Srqs Target Party Trd Grp Comp
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SrqsTargetPartyTrdGrpComp {
