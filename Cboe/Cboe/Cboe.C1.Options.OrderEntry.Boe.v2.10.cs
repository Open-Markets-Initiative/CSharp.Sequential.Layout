...
public unsafe struct AddFloorTradeMessage {
    ...
    public fixed sbyte ClearingOptionalData[16];
    public fixed sbyte ClearingAccount[4];
    public uint CmtaNumber;
    public fixed sbyte FloorTraderAcronym[3];
    public Side Side;
...
public unsafe struct AddFloorTradeRejectedMessage {
    ...
    public fixed sbyte ContraTrader[4];
    public fixed byte Reserved16[16];
    public fixed sbyte RejectText[60];
};
...
public unsafe struct ComplexInstrumentAcceptedMessage {
    ...
    public fixed sbyte ClOrdId[20];
    public fixed sbyte Symbol[8];
    public RevisedLegs RevisedLegs;
    public uint NoOfSecurities;
    public fixed sbyte ReservedInternal[1];
};
...
public unsafe struct CrossOrderAcknowledgmentByte16 {
    ...
    public fixed byte CrossOrderAcknowledgmentReservedBit6Exists[1];
    public fixed byte CrossOrderAcknowledgmentReservedBit5Exists[1];
    public fixed byte CrossOrderAcknowledgmentCompressionExists[1];
    public fixed byte CrossOrderAcknowledgmentReservedBit3Exists[1];
    public fixed byte CrossOrderAcknowledgmentReservedBit2Exists[1];
...
public unsafe struct CrossOrderCancelledByte16 {
    ...
    public fixed byte CrossOrderCancelledReservedBit6Exists[1];
    public fixed byte CrossOrderCancelledReservedBit5Exists[1];
    public fixed byte CrossOrderCancelledCompressionExists[1];
    public fixed byte CrossOrderCancelledReservedBit3Exists[1];
    public fixed byte CrossOrderCancelledReservedBit2Exists[1];
...
public unsafe struct CrossOrderRejectedByte16 {
    ...
    public fixed byte CrossOrderRejectedReservedBit6Exists[1];
    public fixed byte CrossOrderRejectedReservedBit5Exists[1];
    public fixed byte CrossOrderRejectedCompressionExists[1];
    public fixed byte CrossOrderRejectedReservedBit3Exists[1];
    public fixed byte CrossOrderRejectedReservedBit2Exists[1];
...
public unsafe struct FloorTradeNotificationMessage {
    ...
    public fixed sbyte FloorTraderAcronym[3];
    public ulong TradeTime;
    public TradeThroughAlertType TradeThroughAlertType;
    public PriceType PriceType;
    public fixed byte Reserved15[15];
};
...
public unsafe struct NewOrderByte8 {
    public fixed byte NewOrderFloorRoutingInstExists[1];
    public fixed byte NewOrderFloorDestinationExists[1];
    public fixed byte NewOrderCompressionExists[1];
...
public unsafe struct NewOrderCrossByte4 {
    ...
    public fixed byte NewOrderCrossCompressionExists[1];
};
...
public unsafe struct NewOrderCrossMultilegByte4 {
    public fixed byte NewOrderCrossMultilegCompressionExists[1];
...
public unsafe struct OrderAcknowledgmentByte16 {
    ...
    public fixed byte OrderAcknowledgmentFloorDestinationExists[1];
    public fixed byte OrderAcknowledgmentCompressionExists[1];
    public fixed byte OrderAcknowledgmentComboOrderExists[1];
...
public unsafe struct OrderCancelledByte16 {
    ...
    public fixed byte OrderCancelledFloorDestinationExists[1];
    public fixed byte OrderCancelledCompressionExists[1];
    public fixed byte OrderCancelledComboOrderExists[1];
    public fixed byte OrderCancelledReservedBit2Exists[1];
...
public unsafe struct OrderExecutionByte16 {
    ...
    public fixed byte OrderExecutionFloorDestinationExists[1];
    public fixed byte OrderExecutionCompressionExists[1];
    public fixed byte OrderExecutionComboOrderExists[1];
    public fixed byte OrderExecutionReservedBit2Exists[1];
...
public unsafe struct OrderModifiedByte16 {
    ...
    public fixed byte OrderModifiedFloorDestinationExists[1];
    public fixed byte OrderModifiedCompressionExists[1];
    public fixed byte OrderModifiedComboOrderExists[1];
...
public unsafe struct OrderRejectedByte16 {
    ...
    public fixed byte OrderRejectedFloorDestinationExists[1];
    public fixed byte OrderRejectedCompressionExists[1];
    public fixed byte OrderRejectedComboOrderExists[1];
...
public unsafe struct OrderRestatedByte16 {
    ...
    public fixed byte OrderRestatedFloorDestinationExists[1];
    public fixed byte OrderRestatedCompressionExists[1];
    public fixed byte OrderRestatedComboOrderExists[1];
    public fixed byte OrderRestatedReservedBit2Exists[1];
...
public unsafe struct PurgeOrderMessage {
    public fixed sbyte MassCancel[1];
};
