...
/// <summary>
///  Struct for Md Incremental Refresh Book 46
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdIncrementalRefreshBook46 {
    public ulong TransactTime;
    public fixed byte MatchEventIndicator[0];
    public fixed byte Padding2[2];
};
...
/// <summary>
///  Struct for Md Incremental Refresh Trade Summary 48
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdIncrementalRefreshTradeSummary48 {
    public ulong TransactTime;
    public fixed byte MatchEventIndicator[0];
    public fixed byte Padding2[2];
};
...
/// <summary>
///  Struct for Md Instrument Definition Future 54
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdInstrumentDefinitionFuture54 {
    public fixed byte MatchEventIndicator[0];
    public uint TotNumReports;
    public SecurityUpdateAction SecurityUpdateAction;
    public ulong LastUpdateTime;
...
/// <summary>
///  Struct for Md Instrument Definition Option 55
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdInstrumentDefinitionOption55 {
    public fixed byte MatchEventIndicator[0];
    public uint TotNumReports;
    public SecurityUpdateAction SecurityUpdateAction;
    public ulong LastUpdateTime;
...
/// <summary>
///  Struct for Md Instrument Definition Spread 56
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdInstrumentDefinitionSpread56 {
    public fixed byte MatchEventIndicator[0];
    public uint TotNumReports;
    public SecurityUpdateAction SecurityUpdateAction;
    public ulong LastUpdateTime;
