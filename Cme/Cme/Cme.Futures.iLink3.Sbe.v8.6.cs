...
/// <summary>
///  Struct for Execution Report Pending Cancel
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct ExecutionReportPendingCancel {
    public uint SeqNum;
    public ulong Uuid;
    public fixed sbyte ExecId[40];
    public fixed sbyte SenderId[20];
...
/// <summary>
///  Struct for Execution Report Pending Replace
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct ExecutionReportPendingReplace {
    public uint SeqNum;
    public ulong Uuid;
    public fixed sbyte ExecId[40];
    public fixed sbyte SenderId[20];
