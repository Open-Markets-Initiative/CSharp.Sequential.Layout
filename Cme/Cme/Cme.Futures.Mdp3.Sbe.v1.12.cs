...
public unsafe struct InstAttribValue {
    ...
    public fixed byte HedgeInstrument[1];
    public fixed byte EfixInstrument[1];
    public fixed byte MtfRegulated[1];
    public fixed byte SefRegulated[1];
...
public unsafe struct LotTypeRulesGroup {
    ...
    public int MinLotSizeDecimalQty;
};
...
/// <summary>
///  Struct for M D Incremental Refresh Book Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshBookLongQtyGroup {
    public long MdEntryPxOptional;
    public ulong MdEntrySizeUInt64Null;
    public int SecurityId;
    public uint RptSeq;
    public int NumberOfOrdersOptional;
    public byte MdPriceLevel;
...
/// <summary>
///  Struct for M D Incremental Refresh Book Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshBookLongQtyGroups {
    public fixed byte GroupSize[0];
};

/// <summary>
///  Struct for M D Incremental Refresh Book Long Qty Order Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshBookLongQtyOrderGroup {
...
/// <summary>
///  Struct for M D Incremental Refresh Book Long Qty Order Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshBookLongQtyOrderGroups {
...
/// <summary>
///  Struct for M D Incremental Refresh Session Statistics Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshSessionStatisticsLongQtyGroup {
    public long MdEntryPx;
    public ulong MdEntrySizeUInt64Null;
    public int SecurityId;
    public uint RptSeq;
...
/// <summary>
///  Struct for M D Incremental Refresh Session Statistics Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshSessionStatisticsLongQtyGroups {
    public fixed byte GroupSize[0];
};
...
public unsafe struct MDIncrementalRefreshTradeSummaryGroup {
    ...
    public MdUpdateAction MdUpdateAction;
    public uint MdTradeEntryIDUInt32Null;
    public fixed byte Padding2[2];
};
...
/// <summary>
///  Struct for M D Incremental Refresh Trade Summary Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshTradeSummaryLongQtyGroup {
    public long MdEntryPx;
    public ulong MdEntrySizeUInt64;
    public int SecurityId;
    public uint RptSeq;
    public int NumberOfOrders;
    public uint MdTradeEntryIDUInt32;
    public AggressorSide AggressorSide;
    public MdUpdateAction MdUpdateAction;
    public fixed byte Padding6[6];
};
...
/// <summary>
///  Struct for M D Incremental Refresh Trade Summary Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshTradeSummaryLongQtyGroups {
    public fixed byte GroupSize[0];
};

/// <summary>
///  Struct for M D Incremental Refresh Trade Summary Long Qty Order Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshTradeSummaryLongQtyOrderGroup {
    public ulong OrderId;
    public int LastQty;
...
/// <summary>
///  Struct for M D Incremental Refresh Trade Summary Long Qty Order Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshTradeSummaryLongQtyOrderGroups {
    public fixed byte GroupSize8Byte[0];
};
...
/// <summary>
///  Struct for M D Incremental Refresh Volume Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshVolumeLongQtyGroup {
    public ulong MdEntrySizeUInt64;
    public int SecurityId;
    public uint RptSeq;
    public MdUpdateAction MdUpdateAction;
...
/// <summary>
///  Struct for M D Incremental Refresh Volume Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MDIncrementalRefreshVolumeLongQtyGroups {
    public fixed byte GroupSize[0];
};
...
/// <summary>
///  Struct for Md Incremental Refresh Session Statistics Long Qty
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdIncrementalRefreshSessionStatisticsLongQty {
    public ulong TransactTime;
    public fixed byte MatchEventIndicator[0];
    public fixed byte Padding2[2];
};
...
/// <summary>
///  Struct for Md Incremental Refresh Volume Long Qty
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct MdIncrementalRefreshVolumeLongQty {
    public ulong TransactTime;
    public fixed byte MatchEventIndicator[0];
    public fixed byte Padding2[2];
};
...
/// <summary>
///  Struct for Snapshot Full Refresh Long Qty
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshLongQty {
    public uint LastMsgSeqNumProcessed;
    public uint TotNumReports;
    public int SecurityId;
    public uint RptSeq;
...
/// <summary>
///  Struct for Snapshot Full Refresh Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshLongQtyGroup {
    public long MdEntryPxOptional;
    public ulong MdEntrySizeUInt64Null;
    public int NumberOfOrdersOptional;
    public byte MdPriceLevelUInt8Null;
    public OpenCloseSettlFlag OpenCloseSettlFlag;
    public MdEntryType MdEntryType;
};

/// <summary>
///  Struct for Snapshot Full Refresh Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshLongQtyGroups {
    public fixed byte GroupSize[0];
};
...
/// <summary>
///  Struct for Snapshot Full Refresh Tc P Long Qty Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshTcPLongQtyGroup {
    public long MdEntryPxOptional;
    public ulong MdEntrySizeUInt64Null;
    public int NumberOfOrdersOptional;
    public byte MdPriceLevelUInt8Null;
...
/// <summary>
///  Struct for Snapshot Full Refresh Tc P Long Qty Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshTcPLongQtyGroups {
    public fixed byte GroupSize[0];
};
...
/// <summary>
///  Struct for Snapshot Full Refresh Tcp Long Qty
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct SnapshotFullRefreshTcpLongQty {
    public ulong TransactTime;
    public fixed byte MatchEventIndicator[0];
    public int SecurityId;
    public long HighLimitPrice;
...
/// <summary>
///  Struct for Trading Sessions Group
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct TradingSessionsGroup {
    public ushort TradeDate;
    public ushort SettlDate;
    public ushort MaturityDate;
    public fixed sbyte SecurityAltId[12];
};

/// <summary>
///  Struct for Trading Sessions Groups
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public unsafe struct TradingSessionsGroups {
    public fixed byte GroupSize[0];
};
