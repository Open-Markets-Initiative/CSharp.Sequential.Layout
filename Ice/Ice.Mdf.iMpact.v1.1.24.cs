...
public unsafe struct AddOrModifyOrderMessage {
    ...
    public long Price;
    public int Quantity;
    public fixed sbyte IsImplied[1];
    public fixed sbyte IsRfq[1];
...
public unsafe struct MarkerIndexPrices {
    ...
    public fixed sbyte ValuationDateApplyingDate[10];
    public Status Status;
};
...
public unsafe struct MarketEventMessage {
    public int MarketId;
    public fixed sbyte EventType[1];
    public long DateTime;
};
...
public unsafe struct MarketSnapshotMessage {
    ...
    public fixed byte ReservedField1[2];
...
public unsafe struct NewOptionsMarketDefinitionMessage {
    ...
    public fixed sbyte FlexAllowed[1];
    public SettlementType SettlementType;
    public IsBlockOnly IsBlockOnly;
    public GtAllowed GtAllowed;
    public CrossOrderSupported CrossOrderSupported;
